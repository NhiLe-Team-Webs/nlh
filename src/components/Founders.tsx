    ...
    <section id="founders" className="section-spacing bg-founder-bg">
      <div className="container mx-auto container-spacing">
        <div className="max-w-5xl mx-auto text-center scroll-reveal-fade">
          <h2 className="text-sm font-bold uppercase tracking-widest text-primary heading-spacing scroll-reveal-left stagger-1">Người Thuyền Trưởng</h2>
          <p className="text-3xl md:text-5xl lg:text-6xl font-bold text-foreground text-spacing scroll-reveal-right stagger-2">Nhi Le - Hành Trình Của Đam Mê Và Tầm Nhìn</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 max-w-6xl mx-auto">
          ...
          <div className="lg:w-2/3 text-center lg:text-left scroll-reveal-left stagger-4">
            <div className="content-spacing">
              <p className="text-lg lg:text-xl leading-relaxed text-muted-foreground scroll-reveal-fade stagger-5">
              ...
              <blockquote className="border-l-4 border-primary pl-6 italic text-muted-foreground hover:text-foreground hover:border-primary/80 transition-all duration-300 hover:bg-accent/10 p-6 rounded-r-lg hover-lift scroll-reveal-scale stagger-6 text-lg lg:text-xl">
